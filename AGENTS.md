...
- Comparison of shortest path and exploration behavior
...
## Student workflow hint
If output is wrong, paste the failing output and request:
"follow AGENTS.md; minimal diff; fix only X"
